...
stone = ['cube','stone.jpeg',1,-0.25,stoneSoundOptions,"stone",0.4,-20,10,30,0.85,-0.65]
        ...
        if placeable == True:
            if placing == True:
                ...
                if heldBlock.x > 0.30 and heldBlock.y > -0.50:
                    ...
                    if heldBlock.x < 0.30 and heldBlock.y < -0.30:
                        placing = False
